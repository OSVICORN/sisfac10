...
class BarrioView(SinPrivilegios, generic.ListView):
    model = Barrio
    template_name = "fac/barrio_list.html"
    context_object_name = "obj"
    permission_required="cmp.view_barrio"

class BarrioNew(SuccessMessageMixin,SinPrivilegios,\
    generic.CreateView):
    permission_required="inv.add_barrio"
    model=Barrio
    template_name="fac/barrio_form.html"
    context_object_name = "obj"
    form_class=BarrioForm
    success_url=reverse_lazy("fac:barrio_list")
    success_message="Barrio Creado Satisfactoriamente"
...
class BarrioEdit(SuccessMessageMixin,SinPrivilegios, \
    generic.UpdateView):
    permission_required="inv.change_barrio"
    model=Barrio
    template_name="fac/barrio_form.html"
    context_object_name = "obj"
    form_class=BarrioForm
...
@permission_required("fac.change_barrio",login_url="/login/")
def barrioInactivar(request,id):
...
class RutaView(SinPrivilegios, generic.ListView):
    model = Ruta
    template_name = "fac/ruta_list.html"
    context_object_name = "obj"
    permission_required="cmp.view_ruta"

class RutaNew(SuccessMessageMixin,SinPrivilegios,\
    generic.CreateView):
    permission_required="inv.add_ruta"
    model=Ruta
    template_name="fac/ruta_form.html"
    context_object_name = "obj"
    form_class=RutaForm
    success_url=reverse_lazy("fac:ruta_list")
    success_message="Ruta Creada Satisfactoriamente"

    def form_valid(self, form):
        form.instance.uc = self.request.user
        return super().form_valid(form)

class RutaEdit(SuccessMessageMixin,SinPrivilegios, \
    generic.UpdateView):
    permission_required="inv.change_ruta"
    model=Ruta
    template_name="fac/ruta_form.html"
    context_object_name = "obj"
    form_class=RutaForm
    success_url=reverse_lazy("fac:ruta_list")
    success_message="Ruta Actualizada Satisfactoriamente"
...
@login_required(login_url="/login/")
@permission_required("fac.change_ruta",login_url="/login/")
